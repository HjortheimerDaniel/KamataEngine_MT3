...
Vector3 OwnMatrix4x4::Multiply(const float a, const Vector3& vector)
{
	Vector3 result;
...
Matrix4x4 OwnMatrix4x4::Multiply(const Matrix4x4& m1, const Matrix4x4& m2)
{
	Matrix4x4 result;
...
Matrix4x4 OwnMatrix4x4::MakeAffineMatrix(const Vector3& scale, const Vector3& rotate, const Vector3& translate)
{
...
Matrix4x4 OwnMatrix4x4::Inverse(const Matrix4x4& m)
{
	Matrix4x4 result;
	float A;
...
Vector3 OwnMatrix4x4::SphericalToCartesian(float radius, float theta, float phi)
{
	Vector3 cartesian;
...
void OwnMatrix4x4::DrawPlane(const Plane& plane, const Matrix4x4& viewProjectionMatrix, const Matrix4x4& viewMatrix, uint32_t color)
{
...
void OwnMatrix4x4::DrawSphere(const Sphere& sphere, const Matrix4x4& viewProjection, const Matrix4x4 viewportMatrix, uint32_t color)
{
...
void OwnMatrix4x4::EnsureAABB(AABB& aabb)
{
...
void OwnMatrix4x4::DrawTriangle(const Triangle& triangle, const Matrix4x4& viewProjectionMatrix, const Matrix4x4& viewportMatrix)
{
...
void OwnMatrix4x4::DrawAABB(const AABB& aabb, const Matrix4x4& viewProjectionMatrix, const Matrix4x4& viewMatrix, uint32_t color)
{
	Vector3 vertices[8] = {
...
Vector3 OwnMatrix4x4::ClosestPointOnAABB(const Vector3& point, const AABB& aabb)
{
...
Vector3 OwnMatrix4x4::Lerp(const Vector3& a, const Vector3& b, float t)
{
	Vector3 result;
